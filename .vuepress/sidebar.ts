...
import henanSpecializedUndergraduateProgramSideBar from "./sidebars/henanSpecializedUndergraduateProgramSideBar";

// @ts-ignore
export default {
    "/学习路线/": roadmapSideBar,
    "/大学学习资料/": universityStudiesSideBar,
    "/河南升本/": henanSpecializedUndergraduateProgramSideBar,
